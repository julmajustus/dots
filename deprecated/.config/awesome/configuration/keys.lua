...
--    awful.key({ modkey,       }, "r", function () mymainmenu:show() end, {description = "show main menu", group = "awesome"}),
    
    awful.key({ modkey, ctrl  }, "r", awesome.restart, {description = "reload awesome", group = "awesome"}),
    
    awful.key({ modkey, alt }, "Delete", awesome.quit, {description = "quit awesome", group = "awesome"}),
...
awful.keyboard.append_global_keybindings({
    ...
    awful.key({ ctrl,  alt    }, "Right",  awful.tag.viewnext, {description = "view next", group = "tag"}),

    awful.key({ ctrl,  alt    }, "Escape", awful.tag.history.restore, {description = "go back", group = "tag"}),
})
...
awful.keyboard.append_global_keybindings({
    ...
    awful.key({ modkey,		  }, "q", function () awful.layout.inc( 1) end, {description = "select next", group = "layout"}),
              
    awful.key({ modkey, shift }, "q", function () awful.layout.inc(-1) end, {description = "select previous", group = "layout"}),
})
...
awful.keyboard.append_global_keybindings({
	-- File Manager :
    awful.key({ modkey,  }, "f", function () awful.spawn(string.format("thunar")) end, {description = "thunar", group = "file manager"}),
    -- Screenshots Keys :
    awful.key({		   }, "Print", function () awful.util.spawn("screenshot")end, {description = "Maim", group = "screenshot"}),

    awful.key({ modkey }, "Print", function () awful.util.spawn("screenshot-select")end, {description = "Maim", group = "screenshot"}),
	-- Rofi :
    awful.key({ modkey }, "r", function () awful.spawn(string.format("~/.config/rofi/launchers/misc/launcher.sh")) end, {description = "rofi launcher", group = "launcher"}),
	-- Firefox :
    awful.key({ modkey }, "w", function () awful.spawn(string.format("firefox")) end, {description = "rofi launcher", group = "launcher"}),
	-- Center Window :
...
client.connect_signal("request::default_keybindings", function()
    awful.keyboard.append_client_keybindings({
        awful.key({ modkey,           }, "Return", function (c) c.fullscreen = not c.fullscreen c:raise() end, {description = "toggle fullscreen", group = "client"}),
